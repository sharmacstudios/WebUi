...
var Metro = {
    ...
    _loadWidget: function(widget, use_cache) {
        ...
        var loadWidgetData = function(data) {
            ...
            if (docCookies.getItem('socialspaces_metro_ui_sidebar_first_time') !== 'true') {
                Metro.widget_sidebar.addClass('open');
                Metro.widget_sidebar.mouseenter(function() {
                    docCookies.setItem('socialspacs_metro_ui_sidebar_first_time', 'true', Infinity);
